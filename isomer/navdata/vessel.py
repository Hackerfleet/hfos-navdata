        ...
        'properties':
            {
                ...
                'year_built': {
                    'type': 'integer', 'title': 'Year built',
                    'description': 'Year of vessel '
                                   'construction'
                },
                'hull_plan': {
                    'type': 'string', 'title': 'Hull-plan',
                ...
                'motor_count': {
                    'type': 'number', 'title': 'Engines',
                    'description': 'Count of engines'
                },
                'motor_power': {
                    'type': 'number', 'title': 'Enginepower',
                    'description': 'Cumulative engine power (kW)'
                },
                'sail_plan': {
                    'type': 'string', 'title': 'Sail-plan',
                ...
                'sail_area': {
                    'type': 'number', 'title': 'Sail area',
                    'description': 'Maximum unfolded usable '
                                   'sail area (m²)'
                },
                'hull_color': {
                    'type': 'string', 'format': 'colorpicker',
                ...
                'cabins': {
                    'type': 'number', 'title': 'Cabin count',
                    'description': 'Crew cabins'
                },
                'bunks': {
                    'type': 'number', 'title': 'Bunk count',
